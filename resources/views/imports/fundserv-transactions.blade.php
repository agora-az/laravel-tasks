...
@section('title', 'Fundserv Transactions')
...
@section('content')
    ...
    <div class="card" style="margin-bottom: 20px;">
        <form action="{{ route('imports.fundserv.transactions') }}" method="GET">
            <div style="display: flex; gap: 10px;">
                ...
                @if(request('search'))
                    <a href="{{ route('imports.fundserv.transactions') }}" class="btn" style="background: #718096; padding: 10px 20px; text-decoration: none;">Clear</a>
                @endif
            </div>
        </form>
    </div>

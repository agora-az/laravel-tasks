                            ...
                            <tr style="border-bottom: 1px solid #e2e8f0;">
                                ...
                                <td style="padding: 12px; text-align: center;">
                                    <div style="display: flex; gap: 8px; justify-content: center;">
                                        <a href="{{ route('imports.view', $import->id) }}" 
                                        ...
                                        @endif
                                        <form action="{{ route('imports.delete', $import->id) }}" method="POST" style="display: inline-block; margin: 0;"
                                    ...
                                    @if($import->error_details)
                                        <div id="errors-{{ $import->id }}" style="display: none; margin-top: 10px; padding: 10px; background: #fff5f5; border-radius: 4px; text-align: left; font-size: 12px; color: #742a2a;">
                                            <pre style="white-space: pre-wrap; margin: 0;">{{ $import->error_details }}</pre>
                                        </div>
                                    @endif
                                </td>
                            </tr>

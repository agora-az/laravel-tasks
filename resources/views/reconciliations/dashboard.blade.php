...
@section('content')
    ...
    <div style="background:white;padding:25px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:30px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:16px;margin-bottom:24px;">
            <div style="background:linear-gradient(135deg,#4a5568 0%,#2d3748 100%);color:white;padding:24px;text-align:center;border-radius:8px;">
            ...
            <div style="background:linear-gradient(135deg,#38a169 0%,#234e52 100%);color:white;padding:24px;text-align:center;border-radius:8px;">
            ...
            <div style="background:linear-gradient(135deg,#3182ce 0%,#2c5282 100%);color:white;padding:24px;text-align:center;border-radius:8px;">
            ...
            <div style="background:linear-gradient(135deg,#805ad5 0%,#553c9a 100%);color:white;padding:24px;text-align:center;border-radius:8px;">
            ...
            <div style="background:linear-gradient(135deg,#d69e2e 0%,#7d6608 100%);color:white;padding:24px;text-align:center;border-radius:8px;">

<?php $__env->startSection('title', 'Fundserv Transactions'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2 style="margin: 0;">Fundserv Transactions</h2>
        <div style="display: flex; gap: 10px;">
            <a href="<?php echo e(route('imports.index')); ?>" class="btn" style="background: #718096; padding: 10px 20px; text-decoration: none;">
                ← Back to Import
            </a>
            <form action="<?php echo e(route('imports.fundserv.truncate')); ?>" method="POST" style="display: inline;" 
    ...
    <div class="card" style="margin-bottom: 20px;">
        <form action="<?php echo e(route('imports.fundserv.transactions')); ?>" method="GET">
            <div style="display: flex; gap: 10px;">
                ...
                <?php if(request('search')): ?>
                    <a href="<?php echo e(route('imports.fundserv.transactions')); ?>" class="btn" style="background: #718096; padding: 10px 20px; text-decoration: none;">Clear</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="fundserv-row" style="border-bottom: 1px solid #e2e8f0; cursor: pointer;"
                                data-company="<?php echo e($transaction->company); ?>"
                                data-settlement-date="<?php echo e($transaction->settlement_date); ?>"
                                data-trade-date="<?php echo e($transaction->trade_date); ?>"
                                data-fund-id="<?php echo e($transaction->fund_id); ?>"
                                data-dealer-account-id="<?php echo e($transaction->dealer_account_id); ?>"
                                data-order-id="<?php echo e($transaction->order_id); ?>"
                                data-tx-type="<?php echo e($transaction->tx_type); ?>"
                                data-settlement-amt="<?php echo e($transaction->settlement_amt); ?>"
                                data-actual-amount="<?php echo e($transaction->actual_amount); ?>"
                                data-code="<?php echo e($transaction->code); ?>"
                                data-src="<?php echo e($transaction->src); ?>"
                                data-source-identifier="<?php echo e($transaction->source_identifier); ?>">
                                <td style="padding: 12px; color: #4a5568; font-family: monospace;"><?php echo e($transaction->company); ?></td>
                                ...
                                <td style="padding: 12px; text-align: right; color: #2d3748; font-family: monospace;">
                                    <?php echo e($transaction->actual_amount !== null ? '$' . number_format($transaction->actual_amount, 2) : '-'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/staceyrattlesnake/Projects/opus_reconciliation/resources/views/imports/fundserv-transactions.blade.php ENDPATH**/ ?>
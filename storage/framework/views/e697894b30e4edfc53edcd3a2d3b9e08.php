...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-bottom: 40px;">
        <div class="card" style="background: linear-gradient(135deg, #4a5568 0%, #2d3748 100%); color: white; padding: 25px; text-align: center; border-radius: 8px;">
            <div style="font-size: 28px; font-weight: bold; margin-bottom: 8px;"><?php echo e(number_format($totalTransactions)); ?></div>
        ...
        <div class="card" style="background: linear-gradient(135deg, #3182ce 0%, #2c5aa0 100%); color: white; padding: 25px; text-align: center; border-radius: 8px;">
            <div style="font-size: 28px; font-weight: bold; margin-bottom: 8px;"><?php echo e(number_format($fundservTotal)); ?></div>
        ...
        <div class="card" style="background: linear-gradient(135deg, #38a169 0%, #2f855a 100%); color: white; padding: 25px; text-align: center; border-radius: 8px;">
            <div style="font-size: 28px; font-weight: bold; margin-bottom: 8px;"><?php echo e(number_format($viefundTotal)); ?></div>
        ...
        <div class="card" style="background: linear-gradient(135deg, #dd6b20 0%, #c05621 100%); color: white; padding: 25px; text-align: center; border-radius: 8px;">
            <div style="font-size: 28px; font-weight: bold; margin-bottom: 8px;"><?php echo e(number_format($bankTotal)); ?></div>
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-bottom: 40px;">
        <div class="card" style="background: #f7fafc; padding: 25px; border-radius: 8px; border-left: 4px solid #3182ce;">
            <div style="font-size: 24px; font-weight: bold; color: #3182ce; margin-bottom: 5px;"><?php echo e($fundservMatchPercentage); ?>%</div>
            <div style="font-size: 13px; color: #4a5568; margin-bottom: 8px;">Fundserv Matched</div>
            <div style="font-size: 12px; color: #718096;"><?php echo e(number_format($fundservMatched)); ?> of <?php echo e(number_format($fundservTotal)); ?></div>
        </div>
        <div class="card" style="background: #f7fafc; padding: 25px; border-radius: 8px; border-left: 4px solid #38a169;">
            <div style="font-size: 24px; font-weight: bold; color: #38a169; margin-bottom: 5px;"><?php echo e($viefundMatchPercentage); ?>%</div>
            <div style="font-size: 13px; color: #4a5568; margin-bottom: 8px;">VieFund Matched</div>
            <div style="font-size: 12px; color: #718096;"><?php echo e(number_format($viefundMatched)); ?> of <?php echo e(number_format($viefundTotal)); ?></div>
        </div>
        <div class="card" style="background: #f7fafc; padding: 25px; border-radius: 8px; border-left: 4px solid #dd6b20;">
            <div style="font-size: 24px; font-weight: bold; color: #dd6b20; margin-bottom: 5px;"><?php echo e($bankMatchPercentage); ?>%</div>
            <div style="font-size: 13px; color: #4a5568; margin-bottom: 8px;">Bank Matched</div>
            <div style="font-size: 12px; color: #718096;"><?php echo e(number_format($bankMatched)); ?> of <?php echo e(number_format($bankTotal)); ?></div>
        </div>
        <div class="card" style="background: #f7fafc; padding: 25px; border-radius: 8px; border-left: 4px solid #9f7aea;">
            <div style="font-size: 24px; font-weight: bold; color: #9f7aea; margin-bottom: 5px;"><?php echo e(number_format($totalMatches)); ?></div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $recentMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $match): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr style="border-bottom: 1px solid #e2e8f0;">
                            <td style="padding: 12px; color: #2d3748; font-size: 13px;"><?php echo e($match->display_label); ?></td>
                            <td style="padding: 12px; color: #4a5568; font-size: 13px;"><?php echo e(ucfirst($match->left_type)); ?></td>
                            <td style="padding: 12px; color: #4a5568; font-size: 13px;"><?php echo e(ucfirst($match->right_type)); ?></td>
                            <td style="padding: 12px; color: #2d3748; font-size: 13px; font-weight: 500;">$<?php echo e(number_format($match->matched_amount, 2)); ?></td>
                            <td style="padding: 12px; color: #2d3748; font-size: 13px;"><?php echo e(round($match->confidence * 100, 1)); ?>%</td>
                            <td style="padding: 12px; color: #718096; font-size: 13px;"><?php echo e(\Carbon\Carbon::parse($match->created_at)->format('M d, Y H:i')); ?></td>
                        </tr>
    ...
    <div style="display: flex; gap: 10px; margin-top: 30px;">
        <a href="<?php echo e(route('reconciliations.matches')); ?>" class="btn" style="background: #3182ce; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px;">
            View Matches
        </a>
        <a href="<?php echo e(route('reconciliations.index')); ?>" class="btn" style="background: #718096; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px;">
            Reports
        </a>
    </div>
    ...
    <script>
        ...
        const confidenceData = <?php echo json_encode($confidenceData, 15, 512) ?>;
        ...
        new Chart(transactionCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($fundservTotal); ?>, <?php echo e($viefundTotal); ?>, <?php echo e($bankTotal); ?>],
                    backgroundColor: [
                        '#3182ce',
                        '#38a169',
                        '#dd6b20'
        ...
        <?php if($matchesByRule->count() > 0): ?>
            const rulesCtx = document.getElementById('rulesChart').getContext('2d');
            const rulesData = <?php echo json_encode($matchesByRule, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/staceyrattlesnake/Projects/agora-reconciliation/resources/views/reconciliations/dashboard.blade.php ENDPATH**/ ?>
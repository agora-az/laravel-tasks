...
<div class="card" style="margin-bottom: 20px;">
    <div style="display: flex; gap: 10px;">
        <form action="<?php echo e(route('imports.transactions', ['type' => 'fundserv'])); ?>" method="GET" style="flex: 1; display: flex; gap: 10px;">
            ...
            <?php if(request('search')): ?>
                <a href="<?php echo e(route('imports.transactions', ['type' => 'fundserv'])); ?>" class="btn" style="background: #718096; padding: 10px 20px; text-decoration: none;">Clear</a>
            <?php endif; ?>
        </form>
...
<?php /**PATH /Users/staceyrattlesnake/Projects/opus_reconciliation/resources/views/imports/partials/fundserv-table.blade.php ENDPATH**/ ?>
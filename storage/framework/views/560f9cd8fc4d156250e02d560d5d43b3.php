...
<div class="card" style="margin-bottom: 20px;">
    <form action="<?php echo e(route('imports.transactions', ['type' => 'viefund'])); ?>" method="GET">
        <div style="display: flex; gap: 10px;">
            ...
            <?php if(request('search')): ?>
                <a href="<?php echo e(route('imports.transactions', ['type' => 'viefund'])); ?>" class="btn" style="background: #718096; padding: 10px 20px; text-decoration: none;">Clear</a>
            <?php endif; ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="viefund-row" style="border-bottom: 1px solid #e2e8f0; cursor: pointer;"
                            data-client-name="<?php echo e($transaction->client_name); ?>"
                            data-rep-code="<?php echo e($transaction->rep_code); ?>"
                            data-account-id="<?php echo e($transaction->account_id); ?>"
                            data-trx-id="<?php echo e($transaction->trx_id); ?>"
                            data-created-date="<?php echo e($transaction->created_date); ?>"
                            data-trx-type="<?php echo e($transaction->trx_type); ?>"
                            data-trade-date="<?php echo e($transaction->trade_date); ?>"
                            data-settlement-date="<?php echo e($transaction->settlement_date); ?>"
                            data-processing-date="<?php echo e($transaction->processing_date); ?>"
                            data-source-id="<?php echo e($transaction->source_id); ?>"
                            data-status="<?php echo e($transaction->status); ?>"
                            data-amount="<?php echo e($transaction->amount); ?>"
                            data-balance="<?php echo e($transaction->balance); ?>"
                            data-fund-code="<?php echo e($transaction->fund_code); ?>"
                            data-fund-trx-type="<?php echo e($transaction->fund_trx_type); ?>"
                            data-fund-trx-amount="<?php echo e($transaction->fund_trx_amount); ?>"
                            data-fund-settlement-source="<?php echo e($transaction->fund_settlement_source); ?>"
                            data-fund-wo-number="<?php echo e($transaction->fund_wo_number); ?>"
                            data-fund-source-id="<?php echo e($transaction->fund_source_id); ?>"
                            data-available-cad="<?php echo e($transaction->available_cad); ?>"
                            data-balance-cad="<?php echo e($transaction->balance_cad); ?>"
                            data-currency="<?php echo e($transaction->currency); ?>"
                            data-plan-description="<?php echo e($transaction->plan_description); ?>"
                            data-institution="<?php echo e($transaction->institution); ?>">
                            ...
                            <td style="padding: 12px; color: #4a5568; font-family: monospace;"><?php echo e($transaction->trx_type ?? '-'); ?></td>
                            <td style="padding: 12px; color: #4a5568; font-family: monospace;"><?php echo e($transaction->trade_date ?? '-'); ?></td>
                            <td style="padding: 12px; color: #4a5568; font-family: monospace;"><?php echo e($transaction->settlement_date ?? '-'); ?></td>
                            <td style="padding: 12px; color: #4a5568; font-family: monospace;"><?php echo e($transaction->processing_date ?? '-'); ?></td>
                            <td style="padding: 12px; color: #4a5568; font-family: monospace;"><?php echo e($transaction->status ?? '-'); ?></td>
...
<?php /**PATH /Users/staceyrattlesnake/Projects/agora-reconciliation/resources/views/imports/partials/viefund-table.blade.php ENDPATH**/ ?>